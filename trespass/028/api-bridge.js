(() => {
  ...
  async function request({ apiUrl, action, token, guestToken, data = {}, timeoutMs = 20000 }) {
    ...
    Debug.info('bridge', 'Sending backend request', {
      ...
      guestTokenPresent: Boolean(guestToken),
  ...
  Debug.info('bridge', 'Bridge client loaded', { version: '0.2.8', frontendOrigin: location.origin });
})();
